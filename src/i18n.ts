...
export const translations = {
  'pt-BR': {
    ...
    multiAgent: {
      ...
      limit1Number: '5-10',
      limit1Label: 'ferramentas por agente',
      limit1Desc: 'Acima disso, a qualidade de roteamento de ferramentas cai significativamente.',
    ...
    refs: {
      ...
      description: 'Leituras recomendadas, priorizadas para aplicação prática, não para virar track acadêmico.',
  ...
  'en': {
    ...
    navItems: [
      ...
      { id: 'review-checklist', label: 'Checklist' },
      { id: 'quality-matrix', label: 'Matrix' },
    ...
    multiAgent: {
      ...
      description: 'Above 10 tools per agent, quality drops. Specialization and parallelism solve the limits of a single agent.',
      limitsLabel: 'Single-agent limits',
      limit1Number: '5-10',
      limit1Label: 'tools per agent',
      limit1Desc: 'Beyond that, tool-routing quality drops significantly.',
